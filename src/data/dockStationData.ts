...
export const dockStationData: DockStationSpec[] = [
  {
    brand: "Dell",
    model: "WD19 130W Docking Station",
  ...
  {
    brand: "Lenovo",
    model: "USB-C Dual Display Travel Dock",
  ...
  {
    brand: "ThinkPad",
    model: "40AF0135 Universal Docking Station",
  ...
  {
    brand: "Lenovo",
    model: "GaN Charging Dock, Multiport Docking Station",
