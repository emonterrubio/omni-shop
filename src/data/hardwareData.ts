...
export const hardwareData: HardwareSpec[] = [
  {
    ...
    },
    {
      ...
      features: "Sleek, light-weight touchscreen laptop with 13.5″ or 15″ PixelSense display, Dolby Vision IQ & Atmos, Studio Mics, Windows Hello camera, all-day battery",  
      processor: "12th Gen Intel® Core™ i5-1235U or i7-1255U (Evo platform)",
    ...
    },
    {
      ...
      features: "Three-mode hinge convertible, 14.4″ PixelSense Flow touch, Precision Haptic touchpad, Wake on Touch, Slim Pen 2",
    ...
    },
    {
      ...
      features: "AI-accelerated Copilot+ PC with Intel Core Ultra, 13″ PixelSense Flow display, adaptive color, anti-reflective, Surface Kickstand to 165°, dynamic refresh, Ultrawide Studio Camera",
    ...
    },
    {
      ...
      features: "Copilot+ PC 2-in-1 with built-in NPU, 13″ PixelSense OLED (1 M:1 contrast) or IPS Flow, ultrawide front camera, redesigned keyboard, Windows Studio Effects",
    ...
    },
    {
      ...
      processor: "Intel Core Ultra 7 155U (10 cores, up to 4.7 GHz)",
    ...
    },
    {
      ...
      processor: "13th Gen Intel® Core™ i9-13900H (14 cores: 6P + 8E, up to 5.4 GHz)",
    ...
    },
    {
      ...
      processor: "13th Gen Intel® Core™ i7-1365U (10 cores, up to 5.2 GHz)",
      memory: "16 GB Unified Memory",
      storage: "512 GB Storage",
    ...
    },
    {
      ...
      processor: "12th Gen Intel® Core™ i7-1280P (14 cores, up to 4.8 GHz)",
      memory: "16 GB Unified Memory",
      storage: "512 GB Storage",
