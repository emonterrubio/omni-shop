      ...
      {isOpen && (
        <div className="md:hidden">
          <div className="px-2 pb-3 space-y-1 sm:px-3">
            <Link
              href="/"
              className={`block px-4 py-3 text-3xl font-regular text-gray-900 ${pathname === "/" ? "!text-heritageBlue" : ""}`}
            >
              Home
            </Link>
            <Link
            ...
            <Link
              href="/orders"
              className={`block px-4 py-3 text-3xl font-regular text-gray-900 ${pathname === "/orders" ? "!text-heritageBlue" : ""}`}
            >
              Orders
            </Link>
            <Link
            ...
            <Link
              href="/profile"
              className={`block px-4 py-3 text-3xl font-regular text-gray-900 ${pathname === "/profile" ? "!text-heritageBlue" : ""}`}
            >
              Profile
            </Link>
            <Link
              href="/support"
              className={`block px-4 py-3 text-3xl font-regular text-gray-900 ${pathname === "/support" ? "!text-heritageBlue" : ""}`}
            >
              Support
            </Link>
          </div>
